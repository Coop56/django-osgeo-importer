...
def reproject_coordinate_system(layer_name, in_shp_layer):
    ...
    output_shp_file = '%s.shp'.format(layer_name)
    ...
    output_shp_layer = output_shp_dataset.CreateLayer('%s_4326'.format(layer_name), geom_type=ogr.wkbMultiPolygon)
    ...
    prj_file = open('%s.prj'.format(layer_name), 'w')
